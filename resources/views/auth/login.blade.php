            ...
            <div class="row justify-content-center">
               <div class="col-md-10">
                  <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                     <div class="card-body">
                        <a href="{{route('inicio')}}" class="navbar-brand d-flex align-items-center mb-3">
                           ...
                           <div class="row">
                               ...
                               <div class="col-lg-12">
                                  <div class="form-group">
                                     ...
                                     <input class="form-control" type="password" placeholder="********"  name="password"  value="{{old('password')}}" required autocomplete="current-password" >
                                  </div>
                               </div>
                            </div>
